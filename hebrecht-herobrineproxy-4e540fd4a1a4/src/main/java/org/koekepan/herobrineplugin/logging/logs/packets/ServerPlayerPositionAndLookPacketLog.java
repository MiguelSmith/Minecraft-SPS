...
public class ServerPlayerPositionAndLookPacketLog extends TimestampLog {

	private int entityId;
	private double x, y, z;
	private float yaw, pitch;

	public ServerPlayerPositionAndLookPacketLog() {
		this(-1, -1, 0, 0, 0, 0, 0);
	}
	
	public ServerPlayerPositionAndLookPacketLog(long timestamp, int entityId, double x, double y, double z, float yaw, float pitch) {
		super(timestamp);
	...
	public ServerPlayerPositionAndLookPacketLog(long timestamp, PacketEvent event) {
		super(timestamp);
