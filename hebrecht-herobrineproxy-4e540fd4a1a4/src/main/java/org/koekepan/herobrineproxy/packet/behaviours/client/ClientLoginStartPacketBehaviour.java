...
public class ClientLoginStartPacketBehaviour implements Behaviour<Packet>{
	...
	public void process(Packet packet) {
		...
		ConsoleIO.println("ClientLoginStartPacketBehaviour::process => Setting username of ProxySession <"+proxySession.getClass().getSimpleName()+"> to <" + username + ">");
		
		proxySession.setUsername(username);
		ConsoleIO.println("ClientLoginStartPacketBehaviour::process => Player \"" + username + "\" is connecting to <" + serverHost + ":" + serverPort + ">");
